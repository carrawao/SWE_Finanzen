...
const AGB = () => (
  <Container className='d-flex flex-column col-12 mx-0 px-3 pt-4 justify-content-start'>
    ...
    <Typography variant='h7' className='pt-4 ps-3'>
      <List>
        <ListItem>
          1. These Terms and Conditions of Sale shall apply exclusively to entrepreneurs, legal entities under public law or special funds under public law within the meaning of § 310 (1) of the German Civil Code (BGB). We shall only recognize terms and conditions of the Purchaser that conflict with or deviate from our Terms and Conditions of Sale if we expressly agree to their validity in writing. 
        </ListItem>
        <ListItem>
          2. These Terms and Conditions of Sale shall also apply to all future transactions with the Purchaser, insofar as legal transactions of a related nature are concerned (as a precaution, the Terms and Conditions of Sale should be attached to the order confirmation in any case).
        </ListItem>
        <ListItem>
