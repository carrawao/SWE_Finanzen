...
const StockchartCard = props => {
  ...
  return (
    <Card sx={{maxWidth: 750, border: 3, borderColor: 'primary.main', borderRadius: 3}} raised {...props}>
      <CardHeader
        action={<ChartButtons view={view} setView={setView} />}
        title={props.symbol}
      ...
      <Divider />
      <CardContent>
        <Stockchart symbol={props.symbol} view={view} setStockPrice={setStockPrice} setPerf={setPerf}/>
      </CardContent>
      <Divider />
      {
        props.assetType === 'Stock' &&
          <React.Fragment>
            ...
            <Collapse in={open}>
              <Masterdata symbol={props.symbol}/>
            </Collapse>
          </React.Fragment>
      }
    </Card>)
