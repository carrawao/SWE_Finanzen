...
const Stockchart = (props) => {
    ...
    const labels = Object.keys(props.stockdata['Time Series (Daily)']);
    const data = Object.values(props.stockdata['Time Series (Daily)']).map(o => Number(o['4. close'])); 
    ...
    // setViewData(data.slice(0,startDateIndex+1));
    // setViewLabels(labels.slice(0,startDateIndex+1));
    // setup.labels = viewLabels;
    // setup.datasets[0].data = viewData;
    console.log(setup.datasets[0].data[0])
    console.log("-");
    console.log(setup.datasets[0].data[setup.datasets[0].data.length-1]);
    console.log("/");
    console.log(setup.datasets[0].data[0]);
    console.log("=");
    console.log(setup.datasets[0].data[0] - setup.datasets[0].data[setup.datasets[0].data.length-1] / setup.datasets[0].data[0]);
